...
```
# create_role_json.sh jmitchell Test123! <role-name> <list-of-applications>
bash create_role_json.sh jmitchell Test123! firefox123 firefox
```
...
# -or-
bash create_role_json.sh jmitchell Test123! wincmd456 wincmd
...
vim role_mixed.json
# -or-
bash create_role_json.sh jmitchell Test123! mixed "wincmd\",\"firefox"
