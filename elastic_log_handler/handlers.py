...
class CMRESHandler(logging.Handler):
    ...
    __DEFAULT_CA_CERTS = 'ca.pem'
    __DEFAULT_CLIENT_CERT = 'elastic_cert.pem'
    __DEFAULT_CLIENT_KEY = 'elastic_key.pem'
    ...
    def __init__(self,
                 ...
                 client_key=__DEFAULT_CLIENT_KEY):
        """ Handler constructor
    ...
    def __get_es_client(self):
        ...
        if self.auth_type == CMRESHandler.AuthType.HTTPS:
            if self._client is None:
