...
class AuthorizationCodeGrant(BaseGrant):
    ...
    """ Access Token Request requires added parameters specific to RFC7522 """
    ...
    def validate_access_token_request(self):
        ...
        """ IMPLEMENT USING CLIENT_ID PARSED IN SAML ASSERTION
        ...
        """ NO LONGER NEEDED FOR ASSERTION AUTHENTICATION
