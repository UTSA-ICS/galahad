...
# This file has been modified to work with Galahad. Original file can be found here:
...
#registryBase='https://703915126451.dkr.ecr.us-east-2.amazonaws.com'
...
EOJSON
    ...
    jq -R --raw-output "$imageOldConfig" "$dir/$configFile" > "$dir/$imageId/json"
